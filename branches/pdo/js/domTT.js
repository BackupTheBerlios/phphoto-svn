...
function domTT_updatePosition(id)
{
	var tooltip = domTT_tooltips.get(id);
	var node = tooltip.get('node');
	tooltip.set('offsetWidth', node.offsetWidth);
	tooltip.set('offsetHeight', node.offsetHeight);
	var coordinates = domTT_correctEdgeBleed(
		tooltip.get('offsetWidth'),
		tooltip.get('offsetHeight'),
		tooltip.get('mouseX'),
		tooltip.get('mouseY'),
