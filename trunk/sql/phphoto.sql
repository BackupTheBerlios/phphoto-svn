...
create table if not exists phph_config (
	config_name varchar(255) character set latin2 collate latin2_general_ci not null unique,
	config_value text character set latin2 collate latin2_general_ci,
	primary key(config_name)
) ENGINE=InnoDB;

create table if not exists phph_users (
	user_id integer not null unique auto_increment,
	user_login varchar(128) character set latin2 collate latin2_general_ci not null unique,
	user_pass varchar(32) character set latin2 collate latin2_general_ci not null, -- password MD5 
	user_name varchar(256) character set latin2 collate latin2_general_ci,
	user_title varchar(256) character set latin2 collate latin2_general_ci,
	user_email varchar(256) character set latin2 collate latin2_general_ci,
	user_jid varchar(256) character set latin2 collate latin2_general_ci,
	user_www varchar(256) character set latin2 collate latin2_general_ci,
	user_from varchar(256) character set latin2 collate latin2_general_ci,
...
create table if not exists phph_groups (
	...
	group_name varchar(128) character set latin2 collate latin2_general_ci not null unique,
	group_description text character set latin2 collate latin2_general_ci,
...
create table if not exists phph_categories (
	...
	category_name varchar(128) character set latin2 collate latin2_general_ci not null,
	category_description text character set latin2 collate latin2_general_ci,
...
create table if not exists phph_photos (
	...
	photo_title varchar(255) character set latin2 collate latin2_general_ci,
	photo_description text character set latin2 collate latin2_general_ci,
